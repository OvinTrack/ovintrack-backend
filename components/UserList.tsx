  ...
  const renderContent = () =>
  {
    ...
    return (
      <div className="bg-white shadow-md rounded-2xl overflow-hidden">
        ...
        {/* Desktop table */}
        <div className="hidden md:block overflow-x-scroll rounded-2xl [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-track]:bg-slate-100 [&::-webkit-scrollbar-thumb]:rounded-sm [&::-webkit-scrollbar-thumb]:bg-slate-400 [&::-webkit-scrollbar-thumb:hover]:bg-slate-600">
